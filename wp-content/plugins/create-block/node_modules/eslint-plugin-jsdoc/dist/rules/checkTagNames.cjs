...
var _default = exports.default = (0, _iterateJsdoc.default)(({
  ...
  const tagIsRedundantWhenTyped = jsdocTag => {
    ...
    if (context.getFilename().endsWith('.d.ts') && [null, 'Program', undefined].includes(node === null || node === void 0 || (_node$parent = node.parent) === null || _node$parent === void 0 ? void 0 : _node$parent.type)) {
      return false;
    }
